...
function createBasicBoxMesh(){
  ...
  var box = new THREE.Mesh(geomBox, matBox);
    ...
    brick.position.set(-2.4,1.4,4.3);

    var brick1 = new THREE.Mesh(medBrickGeo, brick2Mat);
    brick1.position.set(2.3,2.3,4.3);
